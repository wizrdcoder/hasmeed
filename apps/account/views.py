...
from apps.account.mixins import TwoFactorAuthUserMixin
from apps.account.utils import generate_token, get_challenge_expiration_timestamp
...
from apps.account.models import EmailToken, Profile
...
class UserSetupEmailView(TemplateView):
    ...
    success_url = reverse_lazy("blog:account:setup_email_token")
...
class ProfileUpdateView(
    TwoFactorAuthUserMixin, UserPassesTestMixin, MultiModelFormView
):
    """
