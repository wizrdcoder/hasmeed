...
from apps.account.utils import get_challenge_expiration_timestamp, token_validator
...
class Profile(models.Model):
    ...
    profile_picture = models.ImageField(
        default="profile_pics/default-user.jpg",
    ...
    def is_two_factor_authenticated(self) -> bool:
        ...
        return bool(
            self.is_two_factor_auth_by_token or self.is_two_factor_auth_by_email
        )
...
class EmailToken(models.Model):
    ...
    user = models.ForeignKey(
        User, related_name="user_email_tokens", on_delete=models.CASCADE
    )
